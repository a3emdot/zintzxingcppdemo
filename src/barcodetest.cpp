...
BarcodeTest::BarcodeTest()
  : Test("Barcode", std::make_shared<TestOptions>())
{}

bool BarcodeTest::test(
...
BOOST_FIXTURE_TEST_SUITE(Barcodes, BarcodeTest)
...
BARCODE_TEST(UPCA, "UPCA", "12345")  // NOLINT
BARCODE_TEST(EANX, "EANX", "123456789012")  // NOLINT
BARCODE_TEST(GS1_128, "GS1_128", "(01)12345678901231")  // NOLINT
BARCODE_TEST(CODE128, "CODE128", "121212121212121212121")  // NOLINT

BARCODE_TEST(GS1_DBAR_OMN, "GS1_DBAR_OMN", "1234567890123")  // NOLINT
BARCODE_TEST(GS1_DBAR_OMNSTK, "GS1_DBAR_OMNSTK", "1234567890123")  // NOLINT
